    ...
    <>
      <Paragraphs
        paragraphs={[
          ...
          "Au Valhabba, il est donc interdit de terraformer (c'est-à-dire modifier le terrain) hors de sa base principale. Et dans votre base principale, on vous encourage à le limiter au maximum. Construisez sur pilotis par exemple. Les plus belles bases sont celles qui épousent le terrain de toute manière :D",
