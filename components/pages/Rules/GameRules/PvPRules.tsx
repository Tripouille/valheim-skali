  ...
  return (
    <Paragraphs
      paragraphs={[
        ...
        '- les lieux d’intérêts publics. Ne construisez pas à moins de 200 mètres de l’un d’entre eux. Donjons, cryptes, boss, camps de monstres, PNJ, lieux de quêtes, ruches, etc. doivent rester accessibles à tous.',
